...
public class PlayingNowMoviesAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private static final String TAG = "PlayingNowMoviesAdapter";
    private List<Movie> movieList;

    public interface  OnImageSelectedListener{
        void onImagePlayingNowMovieSelect(long movieID);
    }
    ...
    public PlayingNowMoviesAdapter(List<Movie> movieList) {
            ...
            imgPoster.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (movie.getId() != -1 && mOnImageSelectedListener != null){
                        ...
                        mOnImageSelectedListener.onImagePlayingNowMovieSelect(movieId);
