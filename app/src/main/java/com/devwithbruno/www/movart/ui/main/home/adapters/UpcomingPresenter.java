...
public class UpcomingPresenter<V extends HomeMvpView, I extends HomeMvpInteractor> extends BasePresenter<V, I>
        implements UpcomingAdapterMvpPresenter<V, I> {



    @Inject
    public UpcomingPresenter(I mMvpInteractor, CompositeDisposable compositeDisposable, SchedulerProvider schedulerProvider) {
