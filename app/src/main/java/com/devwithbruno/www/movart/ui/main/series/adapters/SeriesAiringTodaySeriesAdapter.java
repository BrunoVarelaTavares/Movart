...
public class SeriesAiringTodaySeriesAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private static final String TAG = "SeriesAiringTodaySeriesAdapter";
    private List<Tv> mTvList;

    public interface  OnImageSelectedListener{
        void onImageAiringTodaySeriesSelected(long tvId);
    }
    ...
    public SeriesAiringTodaySeriesAdapter(List<Tv> tvList) {
        this.mTvList = tvList;
    }
            ...
            imgPoster.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (tv.getId() != -1 && mOnImageSelectedListener != null){
                        long tvId = tv.getId();
                        mOnImageSelectedListener.onImageAiringTodaySeriesSelected(tvId);
