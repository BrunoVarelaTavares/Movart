...
public class PopularSeriesAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private static final String TAG = "MoviesPopularMoviesAdapter";
    private List<Tv> seriesList;

    public interface  OnImageSelectedListener{
        void onPopularSerieImageSelect(long tvId);
        void onAddTvToWatchlist(Watchlist watchlist);
        void removeTvFromWatchlist(Watchlist watchlist);
        boolean tvIsOnWatchlist(Tv tv);
    }

    public PopularSeriesAdapter.OnImageSelectedListener mOnImageSelectedListener;



    public PopularSeriesAdapter(List<Tv> seriesList) {
        this.seriesList = seriesList;

    }


    public void setOnImageSelectedListener(PopularSeriesAdapter.OnImageSelectedListener mOnImageSelectedListener){
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new PopularSeriesAdapter.MyViewHolder(view);
    }
    ...
    public void addSeries(List<Tv> seriesList) {
    ...
    public class MyViewHolder extends BaseViewHolder{
        ...
        public void onBind(int position) {
            ...
            final Tv tv = seriesList.get(position);

            if (tv.getVote_average() != -1){
                String vote = Double.toString(seriesList.get(position).getVote_average());
                rating.setText(vote);
            }
            ...
            if (mOnImageSelectedListener.tvIsOnWatchlist(tv)) {
                ...
                imageViewBookMarkGreen.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ImageAnimation.unCheckImage(imageViewBookMarkGreen,
                                imageViewCheck, imageViewBookMark, imageViewAdd);
                        mOnImageSelectedListener.removeTvFromWatchlist(GeneralConfig.tvToWatchlist(tv));
                    }
                });
                ...
                imageViewBookMark.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ImageAnimation.checkImage(imageViewBookMark, imageViewAdd,
                                imageViewBookMarkGreen, imageViewCheck);
                        mOnImageSelectedListener.onAddTvToWatchlist(GeneralConfig.tvToWatchlist(tv));
                    }
                });
            ...
            imgPoster.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (tv.getId() != -1 && mOnImageSelectedListener != null){
                        long tvId = tv.getId();
                        mOnImageSelectedListener.onPopularSerieImageSelect(tvId);
