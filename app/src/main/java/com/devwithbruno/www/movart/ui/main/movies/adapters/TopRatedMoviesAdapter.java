...
public class TopRatedMoviesAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private static final String TAG = "PlayingNowMoviesAdapter";
    private List<Movie> movieList;

    public interface  OnImageSelectedListener{
        void onImageTopRatedMovieSelect(long movieID);
    }
            ...
            imgPoster.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (movie.getId() != -1 && mOnImageSelectedListener != null){
                        ...
                        mOnImageSelectedListener.onImageTopRatedMovieSelect(movieId);
