...
public class SeriesTopRatedSeriesAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private static final String TAG = "PlayingNowMoviesAdapter";
    private List<Tv> mTvList;

    public interface  OnImageSelectedListener{
        void onImageTopRatedSerieSelected(long tvId);
    }
    ...
    public SeriesTopRatedSeriesAdapter(List<Tv> tvList) {
        this.mTvList = tvList;
    }
            ...
            imgPoster.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (tv.getId() != -1 && mOnImageSelectedListener != null){
                        long tvId = tv.getId();
                        mOnImageSelectedListener.onImageTopRatedSerieSelected(tvId);
