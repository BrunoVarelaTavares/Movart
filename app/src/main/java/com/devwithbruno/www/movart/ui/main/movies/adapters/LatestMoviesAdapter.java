...
public class LatestMoviesAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private static final String TAG = "PlayingNowMoviesAdapter";
    private List<Movie> movieList;

    public interface  OnImageSelectedListener{
        void onLastestMovieImageSelect(long movieID);
    }
    ...
    public LatestMoviesAdapter(List<Movie> movieList) {
            ...
            imgPoster.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (movie.getId() != -1 && mOnImageSelectedListener != null){
                        ...
                        mOnImageSelectedListener.onLastestMovieImageSelect(movieId);
